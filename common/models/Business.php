...
class Business extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['link'], 'url'],
            [['wallpaper'],'minWidth' => 1920, 'maxWidth' => 1920,'minHeight' => 348, 'maxHeight' => 348,],
            [['logo'],'minHeight' => 56, 'maxHeight' => 56,],
            [['mobile_wallpaper'],'minWidth' => 648, 'maxWidth' => 648,'minHeight' => 348, 'maxHeight' => 348,],
