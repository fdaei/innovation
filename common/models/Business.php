...
class Business extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['link'], 'url'],
            ['wallpaper', 'image', 'minWidth' => 1920, 'maxWidth' => 1920, 'minHeight' => 348, 'maxHeight' => 348, 'extensions' => 'jpg, gif, png', 'maxSize' => 1920 * 348 * 2],
            ['mobile_wallpaper', 'image', 'minWidth' => 648, 'maxWidth' => 648, 'minHeight' => 348, 'maxHeight' => 348, 'extensions' => 'jpg, gif, png', 'maxSize' => 648 * 348 * 2],
            ['logo', 'image','minHeight' => 56, 'maxHeight' => 56, 'extensions' => 'jpg, gif, png,svg', 'maxSize' => 1920 * 348 * 2],
