...
class EventOrganizer extends \yii\db\ActiveRecord
{
    ...
    {
        $query = new EventOrganizerQuery(get_called_class());
        return $query->active();
    }
    ...
    {
        $this->organizer_picture = $this->getUploadUrl('organizer_picture');
        $this->organizer_avatar = $this->getUploadUrl('organizer_avatar');
