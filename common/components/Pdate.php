...
class Pdate extends Component
{
    ...
    /*	F	*/
    function jmktime($h = '', $m = '', $s = '', $jm = '', $jd = '', $jy = '', $none = '', $timezone = 'Asia/Tehran', $gmt = false)
    {
                    ...
                    if ($jm === '') {
                        ...
                        if ($jd === '') {
                            ...
                            if ($jy === '') {
                                ...
                                return $gmt ? gmmktime($h, $m, $s, $gm, $gd, $gy) : mktime($h, $m, $s, $gm, $gd, $gy);
                            }
                        }
                    }
                }
    ...
    function jdate_words($array, $mod = '')
    {
        foreach ($array as $type => $num) {
            ...
            switch ($type) {
                ...
                case'rhfa':
                    $key = array('شنبه', 'یکشنبه', 'دوشنبه', 'سه شنبه', 'چهارشنبه', 'پنجشنبه', 'جمعه');
                    $array[$type] = $key[$num];
                    break;
