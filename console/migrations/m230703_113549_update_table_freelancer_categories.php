...
class m230703_113549_update_table_freelancer_categories extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->alterColumn('{{%freelancer_categories}}','created_at',$this->integer()->unsigned()->notNull());
        $this->alterColumn('{{%freelancer_categories}}','updated_at',$this->integer()->unsigned());
        $this->alterColumn('{{%freelancer_categories}}','created_by',$this->integer()->unsigned()->notNull());
        $this->alterColumn('{{%freelancer_categories}}','updated_by',$this->integer()->unsigned()->notNull());
        $this->alterColumn('{{%freelancer_categories}}','status',$this->tinyInteger()->defaultValue(1)->notNull());
        $this->alterColumn('{{%freelancer_categories}}','deleted_at',$this->integer()->unsigned()->notNull()->defaultValue('0'));
