                ...
                <div class="card-body row">
                    ...
                    <div class="col-3">
                        ...
                        <p class="card-text border-bottom m-2 pb-3">
                            <a href="<?= $model->getUploadUrl('file') ?>" download>
                    ...
                    <div class="col-3">
                        <label><?= Yii::t('app', 'date_advice') ?></label>
                        <p class="card-title border-bottom m-2 pb-3"><?= $model->date_advice ?></p>
                    </div>
                    <div class="col-3">
                        <label><?= Yii::t('app', 'Twitter') ?></label>
                        <p class="card-title border-bottom m-2 pb-3"> <?= MentorsAdviceRequest::itemAlias('TYPE', $model->type); ?></p>
                    </div>
