...
class BusinessesSponsors extends Model
{
    ...
    public function behaviors()
    {
        return [
            [
                ...
                'transferToCDN' => true,
                'cdnPath' => "@cdnRoot/BusinessesSponsors",
                'basePath' => "@inceRoot/BusinessesSponsors",
                'path' => "@inceRoot/BusinessesSponsors",
                'url' => "@cdnWeb/BusinessesSponsors"
            ],
        ];
    }
